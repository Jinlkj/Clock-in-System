...
class Face_Register:
    def __init__(self):
        ...
        self.label_face_cnt = tk.Label(self.frame_right_info, text="当前帧率: ")
        ...
        # 排列
        # self.frame_right_info.grid(row=0, column=1, padx=10, pady=10)
        ...
        # self.label_face_cnt.grid(row=4, column=0)
        # self.log_all.grid(row=5, column=0)
...
# Current frame and face ROI position
    ...
    def GUI_clear_data(self):
        ...
        folders_rd = [file for file in folders_rd if not file.startswith('.')]
    ...
    def GUI_info(self):
        ...
        tk.Label(self.frame_right_info,
                 text="已注册人员").grid(row=2, column=0, columnspan=2, sticky=tk.W, padx=5, pady=2)
        self.label_cnt_face_in_database.grid(row=2, column=2, columnspan=3, sticky=tk.W, padx=5, pady=2)

        tk.Label(self.frame_right_info,
                 text="当前框中人员数").grid(row=3, column=0, columnspan=2, sticky=tk.W, padx=5, pady=2)
        ...
        tk.Label(self.frame_right_info,
                 ...
                 text="删除库中所有人员").grid(row=5, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
        ...
        tk.Label(self.frame_right_info,
                 font=self.font_step_title,
                 text="输入您的姓名").grid(row=7, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
        ...
        tk.Label(self.frame_right_info,
                 font=self.font_step_title,
                 text="存储您的人脸信息").grid(row=9, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
    ...
    def check_existing_faces_cnt(self):
        ...
        person_list = [file for file in person_list if not file.startswith('.')]
        if person_list:
        ...
        if self.face_folder_created_flag:
            if self.current_frame_faces_cnt == 1:
                if not self.out_of_range_flag:
                    insert_person(self.input_name_char)
                    self.ss_cnt += 1
